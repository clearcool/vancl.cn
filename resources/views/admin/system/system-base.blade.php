		...
		<form class="form form-horizontal" id="form-article-add" action="/admin/system/systemupdate" method="post" enctype="multipart/form-data">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
					...
					网站名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" id="website-title" placeholder="控制在25个字、50个字节以内" value="{{ $config->webname }}" class="input-text" name="webname" readonly>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
					...
					关键词：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" id="website-Keywords" placeholder="5个左右,8汉字以内,用英文,隔开" value="{{ $config->keyword }}" class="input-text" name="keyword" readonly>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
					...
					描述：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" id="website-description" placeholder="空制在80个汉字，160个字符以内" value="{{ $config->dsbe }}" class="input-text" name="dsbe" readonly>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
					...
					底部版权信息&copy：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" id="website-copyright" placeholder="&copy; 2016 H-ui.net" value="{{ $config->crtifa }}" class="input-text" name="crtifa" readonly>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">备案号：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" id="website-icp" placeholder="京ICP备00000000号" value="{{ $config->recordnb }}" class="input-text" name="recordnb" readonly>
				</div>
			</div>
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
