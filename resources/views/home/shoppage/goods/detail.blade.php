...
<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/usergoods/detail?sd_id={{$v->sd_id}}&s_id={{$v->s_id}}"><button class="btn btn-default" type="button">查看库存</button>
                                    <button class="delsd btn btn-default" type="button" sdid="{{$v->sd_id}}">删除</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a href="/usergoods/detail?s_id={{$shop->s_id}}"><button class="btn btn-default" type="button">查看全部商品库存</button></a>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="delss btn btn-default" ssid="{{$v->ss_id}}" type="button">删除</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
