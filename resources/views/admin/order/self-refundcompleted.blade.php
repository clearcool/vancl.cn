...
<div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
    ...
    <a style="color:black;line-height:37px;margin-left: 75px;" href="{{url("/admin/order/refund")}}">申请退款的订单</a>
    <a style="color:blue;margin-left: 160px;" href="{{url("/admin/order/refunda")}}">退款完成的订单</a>
    </div>
        {{--已完成的所有订单--}}
