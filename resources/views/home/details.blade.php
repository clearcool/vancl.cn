...
@section('lb')
 ...
 <table id="cpcm" align="center" border="0"> 
         <tbody> 
          <tr class="firstRow"> 
           <td><img alt="" original="/homecss/xiangqing/img/1090426ccx23_08.jpg" width="1200" height="314"  style="display: block;" /> </td>
          </tr>
         </tbody>
        </table> 
        <p></p> 
        <table align="center" border="0"> 
         <tbody> 
          <tr class="firstRow">
           <td><img alt="" original="/homecss/xiangqing/img/1090426ccx23_09.jpg" width="1200" height="314"  style="display: block;" /> </td>
          </tr>
         </tbody>
        </table> 
        <p></p> 
        <table id="xdby" align="center" border="0"> 
         <tbody> 
          <tr class="firstRow"> 
           <td><img alt="" original="/homecss/xiangqing/img/1090426ccx23_12.jpg" width="1200" height="391" src="" style="display: block;" /> </td>
          </tr>
         </tbody>
        </table> 
       </div> 
