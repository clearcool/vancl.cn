...
<div class="page-container">
	<form action="{{url('/admin/product/product-add')}}" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
...
<script type="text/javascript" src="/admincss/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/admincss/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/admincss/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/admincss/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
