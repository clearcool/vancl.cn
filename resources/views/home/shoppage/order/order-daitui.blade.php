...
@section('middle')
    ...
    <div class="container text-center">
        <div class="panel panel-info text-left">
            <div class="panel-heading">订单管理/待退款订单</div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="list-inline">
                                ...
                                <dt>退款原因</dt>
                                <dd>
                                    <span>{{$v->reason == 0 ? '拍错了': ($v->reason == 1 ? '不想要了': ($v->reason == 2 ? '没钱了'  : ($v->reason == 3 ? '卖完后悔了': '其他原因'))) }}</span>
                                </dd>
                                <dd>
                                    <ul class="list-inline btn_ul">
                                        <li><a role="button" class="btn btn-success btn-sm" href="/orders/refund?id={{$v->od_id}}">同意退款</a></li>
                                    </ul>
                                </dd>
                            </div>
