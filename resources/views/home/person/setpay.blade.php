    ...
    <form class="am-form am-form-horizontal">
        ...
        <div class="am-form-group">
            ...
            <a class="btn" href="javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode">
                <div class="am-btn am-btn-danger" style="position: absolute;float: right;margin-left: 830px;margin-top: -40px;">验证码</div>
            </a>
            <span id="verification" style="display:none;color: red;">验证码错误</span>
            <span id="verification1" style="display:none;color: green;">验证码正确</span>
        </div>
        <div class="am-form-group">
